...
const MessageInput = () => {
    ...
    const handleSendMessage = async (e) => {
        ...
        // Only add file data if a file actually exists
        if (attachmentFile) {
        ...
        // if(!message_text && attachmentFile) {
        //     messageData = {
        //     sender_id: authUser.user_id,
        //     receiver_id: selectedUser.user_id,
        //     message_text: "",
  ...
  "
                ...
                >
                    {sendingMessage? <span className="loading text-[#6200B3]  loading-spinner loading-xs"></span> : <Send className='text-[#555555]' />}
                </button>
            </form>
        </div>
    )
